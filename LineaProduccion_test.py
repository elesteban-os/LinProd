...
def test_linea_produccion():
    ...
    proceso3 = Proceso(3, proceso_inicial=False) # Proceso extra para probar cuello de botella
    ...
    while True:
        ...
        linea.parar_linea()
        if linea.en_pausa:
            print("[SISTEMA] Línea vacía y pausada. Deteniendo simulación.")
            break
